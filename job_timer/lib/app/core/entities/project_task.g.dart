...
const ProjectTaskSchema = CollectionSchema(
  name: 'ProjectTask',
  schema:
      '{"name":"ProjectTask","idName":"id","properties":[{"name":"created","type":"Long"},{"name":"durantion","type":"Long"},{"name":"name","type":"String"}],"indexes":[],"links":[]}',
  idName: 'id',
  propertyIds: {'created': 0, 'durantion': 1, 'name': 2},
  listProperties: {},
  indexIds: {},
  indexValueTypes: {},
  linkIds: {},
...
void _projectTaskSerializeNative(
  ...
  final value1 = object.durantion;
  final _durantion = value1;
  ...
  writer.writeLong(offsets[1], _durantion);
...
ProjectTask _projectTaskDeserializeNative(
  ...
  object.durantion = reader.readLong(offsets[1]);
  object.id = id;
...
dynamic _projectTaskSerializeWeb(
  ...
  IsarNative.jsObjectSet(jsObj, 'durantion', object.durantion);
...
ProjectTask _projectTaskDeserializeWeb(
  ...
  object.durantion =
      IsarNative.jsObjectGet(jsObj, 'durantion') ?? double.negativeInfinity;
...
P _projectTaskDeserializePropWeb<P>(Object jsObj, String propertyName) {
  switch (propertyName) {
    ...
    case 'durantion':
      return (IsarNative.jsObjectGet(jsObj, 'durantion') ??
...
extension ProjectTaskQueryWhereSortBy
  ...
  QueryBuilder<ProjectTask, ProjectTask, QAfterSortBy> sortByDurantion() {
    return addSortByInternal('durantion', Sort.asc);
  }

  QueryBuilder<ProjectTask, ProjectTask, QAfterSortBy> sortByDurantionDesc() {
    return addSortByInternal('durantion', Sort.desc);
  }
...
extension ProjectTaskQueryWhereSortThenBy
  ...
  QueryBuilder<ProjectTask, ProjectTask, QAfterSortBy> thenByDurantion() {
    return addSortByInternal('durantion', Sort.asc);
  }

  QueryBuilder<ProjectTask, ProjectTask, QAfterSortBy> thenByDurantionDesc() {
    return addSortByInternal('durantion', Sort.desc);
  }
...
extension ProjectTaskQueryWhereDistinct
  ...
  QueryBuilder<ProjectTask, ProjectTask, QDistinct> distinctByDurantion() {
    return addDistinctByInternal('durantion');
  }
...
extension ProjectTaskQueryProperty
  ...
  QueryBuilder<ProjectTask, int, QQueryOperations> durantionProperty() {
    return addPropertyNameInternal('durantion');
  }
